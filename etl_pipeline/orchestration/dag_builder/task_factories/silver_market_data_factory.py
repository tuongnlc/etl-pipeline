...
from etl_pipeline.orchestration.airflow.python_script.postgre_to_bq import main
...
class SilverMarketDataTaskFactory(TaskFactoryBase):
    ...
    """
    from etl_pipeline.models.orchestration.task_factories.silver_market_data_factory import SilverMarketDataTaskModel
